...
$(document).ready(function() {
	...
	$("#input_nom_joueurs input").on("input.changeNomJoueurs", function(e){
		...
		$(".nomJoueur" + numero).text(text.replace(/:/g, "").trim());
	});
	...
	//on trigger venjHasard si on est dans un multiple de 4 
	if(($("#titre_nb_manche span").text() - 1)%4 == 0){
		$("#ventJHasard").trigger("click.ventjHasard");
	}
