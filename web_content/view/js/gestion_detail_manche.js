...
$(document).ready(function() {
    ...
    $("#contient_tab_detail_manche").hide();
    
    $("#annonce_detail_manche").on("click.display_detail", function(e) {
		if(tab_detail_manche_display){
	    	rotate(0, $(this).children(".glyphicon"));
			//rotateV2(90, 0, 600, $(this).children(".glyphicon"));
	    	
	    		$("#contient_tab_detail_manche").slideToggle("slow");
		}else{
		    rotate(90, $(this).children(".glyphicon"));
		    //rotateV2(0, 90, 600, $(this).children(".glyphicon"));
